...
//This is the main service that makes Don't Pause do what it does. MainService.java is the standard service, and MyService2.java is "Tablet Mode"
...
public class MainService extends Service {
    ...
    public void onCreate() {
        ...
        if (notifyenabled) {
            ...
            //Show notification
            Notification notification = new Notification(R.drawable.ic_menu_share, "Service Started", System.currentTimeMillis());
